...
export function HeroSection() {
  return (
    <section className="relative pt-[100px] pb-[var(--spacing-block)] overflow-hidden max-[1100px]:pb-[120px]">
        ...
        <div className="grid grid-cols-[1.05fr_1fr] gap-12 items-center relative z-[2] max-[1100px]:grid-cols-1">
          <div>
            ...
            <div className="flex gap-3 mt-10 reveal max-sm:flex-col">
              ...
              <Link href="/simulateur-cee" className="btn btn-secondary">
                {hero.ctaSecondary}
              </Link>
            </div>
            <div className="mt-14 flex items-center gap-3.5 text-sm text-[var(--color-text-2)] reveal max-sm:flex-wrap">
              ...
              <span>
                ...
                <span
                  ...
                  data-tip="Organisme professionnel de qualification d'ingénierie"
                >
                  OPQIBI 1905
                </span>{" "}
                ·{" "}
